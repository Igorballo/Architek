...
<head>
    ...
    <link rel="stylesheet" href="/admin/imagebox/style.css">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>A propos de nous</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="{{ route('contactadmin') }}">Contact</a>
                                </li>
                                <li>
                                    <a href="{{ route('infos') }}">Informations sur ArchiteK</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ route('projetadmin') }}">
                                <i class="fas fa-chart-bar"></i>Ajouter un projet</a>
                        </li>
                        <li>
                            <a href="{{ route('serviceadmin') }}" >
                                <i class="fas fa-table"></i>Ajouter un service</a>
                        </li>
                        <li>
                            <a href="{{ route('collaborateur') }}" >
                                <i class="far fa-check-square"></i>Ajouter un collabollateur</a>
                        </li>
                        <li>
                            <a href="{{ route('admin') }}" >
                                <i class="fas fa-calendar-alt"></i>Ajouter un administrateur</a>
                        </li>
                        <li>
                            <a href="map.html">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('collaborateur') }}" >
                                <i class="far fa-check-square"></i>Ajouter un collaborateur</a>
                        </li>
                        <li>
                            <a href="{{ route('admin') }}" >
                                <i class="fas fa-calendar-alt"></i>Creer un administrateur</a>
                        </li>
                        <li>
                            <a href="map.html">
                                <i class="fas fa-map-marker-alt"></i>Blog</a>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="/storage/image/admins/{{$user->photo}}" alt="{{$user->full_name}}" />
                                        </div>
                                        <div class="content">
