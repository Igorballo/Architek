                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="login-checkbox" style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">
                                    <label>
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" style="background-color: orange;" type="submit">Se connecter</button>
